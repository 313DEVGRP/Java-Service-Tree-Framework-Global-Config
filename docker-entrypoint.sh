...
MONITOR_ELK_OPTS="-javaagent:/elastic-apm-agent.jar -Delastic.apm.service_name=global-config -Delastic.apm.application_packages=com.arms -Delastic.apm.server_urls=http://apm-server:8200"
